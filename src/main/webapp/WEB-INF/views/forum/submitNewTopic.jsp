...
<head>
    ...
    <script type="text/javascript" src="/js/tool/ckeditor/ckeditor.js"></script>
    <!-- Bootstrap CSS -->
    <link rel="stylesheet"
...
<div class="container-fluid pl-5 pr-5">
    <i class="fas fa-home"></i><span class="ml-1">home > ${category.title} > ${discussion.title}</span>
    <hr>
    <div class="mt-3">
        <h3>Create New Topic</h3>
    </div>
    <div class="" style="height: border-box">
        <!--    -->
        <div class=" mt-2 mb-4">
            <div class="bg-white" style="height: 40rem">
                ...
                <form action="<c:out value="/main/forum/${discussion.id}"/> "class="p-3" method="post">
                <div class="">
                    ...
                    <div class="forum-group mt-4">
                        ...
                        <script type="text/javascript">
                          CKEDITOR.replace('editor',
                              {filebrowserUploadUrl: '/main/forum/uploadImg'});
                        </script>
